...
class ClassificationHead(nn.Module):
    def __init__(self, input_dim, hidden_dims, output_dim, dropout=0.1):
        ...
        self.conv_block1 = ConvBlock(in_channels=512, out_channels=256, kernel_size=1, pad='same')
        self.conv_block2 = ConvBlock(in_channels=256, out_channels=128, kernel_size=1, pad='same')
        self.pool1 = nn.AvgPool2d(kernel_size=2, stride=2)
        self.conv_block3 = ConvBlock(in_channels=128, out_channels=64, kernel_size=1, pad='same')
        self.conv_block4 = ConvBlock(in_channels=64, out_channels=32, kernel_size=1, pad='same')
...
class TemporalConvNet(nn.Module):
    def __init__(self, input_shape=(288, 512), spatial_channels=64, num_frames=5):
        ...
        self.classification = ClassificationHead(input_dim =4608, hidden_dims=[1024, 512, 256], output_dim=2)
    ...
    def forward(self, x):
        ...
        return (horizontal_heatmap, vertical_heatmap), classification
